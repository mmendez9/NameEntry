...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnClick(View view) {
        // Create a TextView and EditText
        TextView text = (TextView) findViewById(R.id.Nametf);
        EditText name = (EditText) findViewById(R.id.nameInput);

        Log.d("Name", "Hello " + name.getText().toString());

        // Snackbar
        Snackbar.make(view, "Hello " + name.getText().toString() , Snackbar.LENGTH_LONG)
                .setAction("Action", null).show();
